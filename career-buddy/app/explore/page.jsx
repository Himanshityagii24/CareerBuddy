            ...
            <section className="md:px-0 mx-6 xl:w-4/5 2xl:w-[66%] md:mx-auto">
                ...
                <div className="">
                    ...
                    <div className="flex justify-center items-center h-full">
                        {/* Video component removed - replace with your preferred video solution */}
                        <div className="w-full max-w-2xl aspect-video bg-gray-200 rounded-lg flex items-center justify-center">
                            <p className="text-gray-500">Video placeholder - replace with your video component</p>
                        </div>
                    </div>
                    <br /><br />
                ...
                <div className="">
                    ...
                    <p className="md:text-center py-8 md:w-1/2 mx-auto text-xl md:text-2xl text-gray-500 ">
                        These are some points one should consider before choosing arts stream
                    </p>
                    <div className="md:text-center py-8 md:w-1/2 mx-auto">
                        <ul className="list-disc list-inside text-xl md:text-2xl text-gray-500">
